...
contract Presale is Ownable, ReentrancyGuard {
    ...
    address public weth;
    uint8 constant private FEE = 14; //7% for the team 7% for cex //TEST
    uint8 public teamDrop;
    uint8 public tokenDecimals;
    uint256 public presaleTokens;
    uint256 public ethRaised;
    uint256 public coldTokenAmount;
    uint256 public coolTime1 = 5 minutes; //TEST
    uint256 public coolTime2 = 7 minutes; //TEST
    uint256 public coolTime3 = 10 minutes; //TEST
    uint64 public saleTime = uint64(5 minutes); //TEST
    ...
    */
    ...
    function makeIsFinish() external { //TEST
        isFinish = true;
    }
    ...
    */
    function finishSale() external onlyOwner onlyInactive{
        ...
        if (ethRaised < pool.hardCap) {
            uint256 remainder = presaleTokens; //pool.totalSupply - (presaleTokens + tokensForLiquidity + tokensForFee);
            if(burnTokens == true){
    ...
    */
    function claimColdTokens() external onlyInactive nonReentrant {
        ...
        require(block.timestamp > (pool.endTime + coolTime3), "Still Cooling"); //TEST
    ...
    */
    ...
    function withdrawEth() external { //TEST
    ...
    function airdrop(
        ...
        tokenInstance.presaleDon(team1,(pool.totalSupply * 25 / 2000)); //2.5 % 1/2 //TEST
